    ...
    while True:
        try:
            ...
            detections = detector.detectCustomObjectsFromImage(
                ...
                output_image_path= f'materials/out.png',
                minimum_percentage_probability=80)
                ...
                for b in detections:
                    if b['name'] == 'person':
                        ...
                        for x in user.meetings:
                            if x.find == False and x.box_points[0] - 130 <= b['box_points'][0] and x.box_points[1] - 130  <= b['box_points'][1] and x.box_points[2] + 130 >= b['box_points'][2] and x.box_points[3] + 130 >= b['box_points'][3]:
                                print(x.box_points)
